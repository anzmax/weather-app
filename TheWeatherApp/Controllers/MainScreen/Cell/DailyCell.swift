...
class DailyCell: UITableViewCell {
    ...
    lazy var dateLabel: UILabel = {
        ...
        let attributedString = NSMutableAttributedString(string: "17/04", attributes: [
            .font: font,
    ...
    lazy var tempLabel: UILabel = {
        let label = UILabel()
        let font = UIFont(name: RubikFonts.regular.rawValue, size: 18) ?? UIFont.systemFont(ofSize: 18)
